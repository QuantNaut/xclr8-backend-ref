...
import com.xclr8.api.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("com.xclr8.api.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory) throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.xclr8.api.config.dbmigrations");
